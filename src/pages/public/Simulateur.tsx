...
const PATHS: Array<{
  ...
  },
  {
    ...
    duration: '5 minutes',
    description: 'Décrivez votre problème + votre adresse. Vous recevez les travaux les plus pertinents et les aides applicables.',
    features: [
      'Travaux adaptés à votre situation',
      'Aides nationales + aides Bretagne',
      'Aucune saisie technique',
    ],
