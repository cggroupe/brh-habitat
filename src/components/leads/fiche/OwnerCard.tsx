    ...
    <article className="rounded-lg border border-slate-200 bg-white p-4 transition hover:border-slate-300 hover:shadow-sm">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0 flex-1">
          ...
          <h3 className="mt-0.5 truncate font-display text-base font-semibold text-slate-900">
            {denomination}
          </h3>
      ...
      <div className="mt-3 grid gap-3 sm:grid-cols-2">
        ...
        <div className="space-y-1">
          <div className="text-[10px] uppercase tracking-wide text-slate-400">Coordonnées</div>
          <DetailRow
            label={
        ...
        {/* Zone 4 — Adresse siège */}
        <div className="space-y-1">
          <div className="text-[10px] uppercase tracking-wide text-slate-400">Siège</div>
          <DetailRow
            label={
              <span className="flex items-center gap-1">
