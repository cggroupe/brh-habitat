...
export default function ChiffragesList({ partnerType, newChiffrageUrl }: ChiffragesListProps) {
  const { user } = useAuth()
  const [downloadingId, setDownloadingId] = useState<string | null>(null)
  const { data: chiffrages = [], isLoading } = useMyChiffrages(user?.id)

  async function handleDownload(row: BrhChiffrageRow) {
